...
<jsp:include page="/jsp/Master.jsp">
	...
	<jsp:param name="content">
		<jsp:attribute name="value">
    		<script src="js/materia/Revisar.js"></script>		
			<section style="clear: both">

	            <form action="Revisar" method="post" name="form1" id="form1">
	                ...
	                <div style="text-align: center; margin-bottom: 30px">
						<c:if test="${tieneAutoridad == true}">
		                    ...
		                    <table class="list1 green" style="width:50%25">
		                        <tr>
		                           <th width="30%25" class="right">Fecha de Revisar</th>
		                           <td width="50%25" class="left">${fechaSolicitud}</td>
		                       </tr>
		                       <tr>
		                           <th width="30%25" class="right">Persona de Revisor</th>
		                       ...
		                       <tr>
		                           ...
		                           <td width="50%25" class="left">
		                               <input type="radio" class="resultado" name="resultado" value="${radioRevisado}" id="resulRevisado"><label for="resulRevisado">Revisado</label>
	                       ...
	                       <div class="bastidor">
	                        <input type="button" value="Revisar" class="botonimagenchico" onclick="funcRevisar()"/>
