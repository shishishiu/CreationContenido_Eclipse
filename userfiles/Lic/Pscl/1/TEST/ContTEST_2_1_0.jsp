...
<table width="800"  border="0" align="center">
  <tr>
    ...
    <td valign="top" >
 	...
 	<!-- InstanceBeginEditable name="Trabajo" --><p><iframe frameborder="0" height="500" scrolling="no" src="HTML5/ContTEST_2_1_1/ActComLPSBC07PLS02_1_2.html" width="1000"></iframe></p><p>&nbsp;</p> 	 	 	
 	<!-- InstanceEndEditable -->	
 </div>
  ...
  <div style="overflow: auto; width: 100%; height: 52px;" id="divscroll2">
 	...
 	<table width="100%" border="0" height="100%" >
      <tr>
        <td width="20%">&nbsp;</td>
        <td class="label_Conceptual">2.1. ANTECEDENTES DE LA POSTURA EMPÍRICO-ANALÍTICA</td>
        <td width="20%">&nbsp;</td>
      </tr>
    </table>
    <!-- InstanceEndEditable -->	
