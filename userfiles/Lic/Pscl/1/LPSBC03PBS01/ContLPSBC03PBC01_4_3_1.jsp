...
%>">
 	...
 	<h2><strong>4.3.1 TIPOS DE MOTIVACI&Oacute;N</strong><br />
 	  </h2>
 	<p align="justify">Se suele definir a la <strong>motivaci&oacute;n intr&iacute;nseca</strong> como aquel estado subjetivo que promueve y mantiene la realizaci&oacute;n de una actividad por la actividad misma, sin que medie ninguna finalidad o recompensa externa. Dicho de otro modo, la actividad se convierte en una finalidad o en un motivo en s&iacute; misma, y no un medio para otra finalidad diferente.<br />
 	  </p>
 	<p align="justify">El profesor e investigador americano Cs&iacute;kszentmih&aacute;lyi ha estudiado en profundidad las caracter&iacute;sticas componentes de la experiencia subjetiva (estados de conciencia) que acompa&ntilde;an a la motivaci&oacute;n intr&iacute;nseca. Ha denominado a este estado de conciencia <strong>experiencia de flujo</strong> (y tambi&eacute;n conciencia autot&eacute;lica o experiencia &oacute;ptima), y se caracteriza por que el sujeto se muestra de la manera siguiente:</p>
    <div align="justify">
      <ul>
        <li>Est&aacute; totalmente concentrado (e implicado) en la realizaci&oacute;n de la tarea).</li>
        <li>El alt&iacute;simo nivel de concentraci&oacute;n en la tarea produce a veces p&eacute;rdida de la conciencia del Yo (la persona est&aacute; tan concentrada en lo que hace que se olvida de ella misma).</li>
        <li>Tiene una sensaci&oacute;n alta de control sobre la tarea y sus resultados.</li>
        <li>Tiene una percepci&oacute;n &ldquo;distorsionada&rdquo; del paso del tiempo (normalmente parece transcurrir mucho m&aacute;s de prisa).</li>
        <li>Se siente bien, desde un punto de vista emocional (suele sentirse contenta, satisfecha, activa y confiada.</li>
      </ul>
    </div>
    <p align="justify">Cuando una persona se esfuerza y persiste en la ejecuci&oacute;n de una tarea sin que haya incentivos extr&iacute;nsecos, y en el plano subjetivo experimenta con una cierta intensidad los elementos que acabamos de se&ntilde;alar, podemos decir que est&aacute; motivada intr&iacute;nsecamente.<br />
    </p>
    <p align="justify">La conducta de juego en los humanos &ndash;y tambi&eacute;n en otras especies animales- se puede considerar ejemplo de conducta intr&iacute;nsecamente motivada. En las personas adultas, las aficiones son lo m&aacute;s pr&oacute;ximo a conductas totalmente motivadas de forma intr&iacute;nseca. La motivaci&oacute;n intr&iacute;nseca tambi&eacute;n suele ser alta en las actividades profesionales creativas como escribir, pintar, componer, etc. Sin embargo, se ha de tener en cuenta que la motivaci&oacute;n intr&iacute;nseca no es patrimonio exclusivo de estas actividades, sino que pr&aacute;cticamente cualquier tipo de tarea puede llegar a suscitar inter&eacute;s intr&iacute;nseco.<br />
      <strong><br />
    </strong> </p><table width="100%" border="0" height="100%">
      <tr>
        <td width="20%"><div align="center"><a href= "ContLPSBC03PBC01_4_3_0.jsp" ><img src="Img/REGRESAR.png" width="99" height="32" /></a></div></td>
        <td class="label_Conceptual"><strong>4.3 MOTIVACI&Oacute;N</strong></td>
        <td width="20%"><div align="center"><a href= "ContLPSBC03PBC01_4_3_2.jsp" ><img src="Img/AVANZAR.png" width="99" height="32"/></a></div></td>
      </tr>
    </table>
 	<!-- InstanceEndEditable -->
