...
%>">
 	...
 	<h2><strong>3.1.2 RAZONAMIENTO DEDUCTIVO</strong></h2>
    <p>Este tipo de razonamiento parte de premisas generales para llegar a una conclusi&oacute;n particular. Estas premisas son aceptadas como verdades universales y necesariamente se llega a una conclusi&oacute;n. </p>
<p align="justify">&nbsp;</p>
    <p align="center"><img src="Img/UNIDAD 3/pcb_un3img11.jpg" width="200" height="131" /></p>
    <p>&nbsp;</p>
    <p>Ejemplo:<br />
      Premisa 1 (general): &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Todos los hombres son racionales <strong>(Correcto y verdadero)</strong><br />
      Premisa 2. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Juanito es hombre <strong>(Correcto y verdadero)</strong><br />
      Conclusi&oacute;n (particular). &nbsp;Por lo tanto Juanito es Racional <strong>(Correcto y verdadero)</strong></p>
    <p>Podemos encontrar tambi&eacute;n que de una premisa falsa se concluya otra idea verdadera, por ejemplo:</p>
    <p>Premisa 1. &nbsp;&nbsp;Todos los animales son racionales <strong>(Correcto, Falso)</strong><br />
      Premisa 2.&nbsp; &nbsp;S&oacute;crates es animal <strong>(Correcto, verdadero)</strong><br />
      Conclusi&oacute;n. Por lo tanto S&oacute;crates es racional <strong>(Correcto, verdadero)</strong></p>
    <p align="justify">Es momento de poner a prueba tus competencias adquiridas hasta el momento en esta unidad en la resoluci&oacute;n de la primer actividad de aprendizaje. Adelante y mucho &eacute;xito.</p>
    <p align="center"><img src="Img/UNIDAD 3/pcb_un3img12.jpg" width="90" height="114" /></p>
    <a href="../../../../ActApart.jsp?unidad=3&amp;apartado=1">
 <h2>ACTIVIDAD DE APRENDIZAJE 3.1<br /></h2></a>
  </p><table width="100%" border="0" height="100%">
      <tr>
        <td width="20%"><div align="center"><a href= "ContLPSBC03PBC01_3_1_1.jsp" ><img src="Img/REGRESAR.png" width="99" height="32" /></a></div></td>
        <td class="label_Conceptual"><strong>3.1 PENSAMIENTO</strong></td>
        <td width="20%"><div align="center"><a href= "ContLPSBC03PBC01_3_2_0.jsp" ><img src="Img/AVANZAR.png" width="99" height="32"/></a></div></td>
      </tr>
    </table>
 	<!-- InstanceEndEditable -->
