...
%>">
 	...
 	<h1 align="center"><strong>2.4 APRENDIZAJE Y DISPOSICIONES INNATAS DE CONDUCTA </strong><br />
 	  </h1>
 	<h2><strong>2.4.1 GENERALIDADES</strong></h2>
    <p align="justify">El siguiente gr&aacute;fico explica los elementos que intervienen de forma inminente para el aprendizaje de todo tipo de conducta, es necesario que posicione el rat&oacute;n sobre el concepto para leer la informaci&oacute;n.</p>
...
<div align="center"><img src="Img/UNIDAD 2/pcb_un2img43.jpg" width="496" height="289" border="0" usemap="#Map"  />
  <map name="Map" id="Map">
  
  <area shape="rect" coords="192,194,297,237" href="#" onclick="mostrarTablas('evento2');OcultarTablas('evento1');OcultarTablas('evento3');"/>
  
  <area shape="rect" coords="252,89,357,132" href="#" onclick="mostrarTablas('evento1');OcultarTablas('evento2');OcultarTablas('evento3');"  />
  
    <area shape="rect" coords="132,89,237,132" href="#" onclick="mostrarTablas('evento3');OcultarTablas('evento1');OcultarTablas('evento2');" />
  </map>
</div>
...
<table width="80%" border="0"  align="center" cellspacing="10" cellpadding="10">
  <tr>
    <td valign="top"><div id="evento1" style="display: none"><p align="justify"><strong>TEMPERAMENTO: </strong>Peculiaridad e intensidad individual de los afectos ps&iacute;quicos y de la estructura dominante de humor y motivaci&oacute;n.</p></div>
    
      <div id="evento2" style="display: none"><p align="justify"><strong>CAR&Aacute;CTER:</strong> conjunto de reacciones y h&aacute;bitos de comportamiento que se han &nbsp;adquirido durante la vida y que dan especificidad al modo de ser individual.</p></div>
      
     <div id="evento3" style="display: none"> <p align="justify"><strong>HERENCIA:</strong> Cuestiones gen&eacute;ticamente adquiridas, gestos, formas de reaccionar&nbsp; ante ciertas situaciones</p></div></td>
  </tr>
</table>
<p align="justify">Todos los elementos descritos anteriormente son disposiciones innatas o aprendidas de conducta que posibilitan el aprendizaje.</p>
<p align="justify">Te invitamos a que  realices cuidadosamente la actividad de aprendizaje que aparece a continuaci&oacute;n,  recuerda que ser&aacute; tomada en cuenta para tu evaluaci&oacute;n.</p>
<a href="../../../../ActApart.jsp?unidad=2&amp;apartado=4">
 <h2>ACTIVIDAD DE APRENDIZAJE 2.4<br /></h2></a>
  </p>
<table width="100%" border="0" height="100%">
      <tr>
        <td width="20%"><div align="center"><a href= "ContLPSBC03PBC01_2_3_3.jsp" ><img src="Img/REGRESAR.png" width="99" height="32" /></a></div></td>
        <td class="label_Conceptual"><p><strong>2.4 APRENDIZAJE Y DISPOSICIONES INNATAS DE CONDUCTA</strong></p></td>
        <td width="20%"><div align="center"><a href= "ContLPSBC03PBC01_2_Resumen.jsp" ><img src="Img/AVANZAR.png" width="99" height="32"/></a></div></td>
      </tr>
    </table>
 	<!-- InstanceEndEditable -->
