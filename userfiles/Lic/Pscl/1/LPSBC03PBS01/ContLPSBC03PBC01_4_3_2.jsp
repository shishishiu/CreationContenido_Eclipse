...
%>">
 	...
 	<h2><strong>4.3.2 EL PROCESO MOTIVACIONAL </strong><br />
 	  </h2>
 	<p><strong><em>Procedimientos para fomentar la motivaci&oacute;n intr&iacute;nseca</em></strong><br />
 	  </p>
 	<p align="justify">Seguramente lo m&aacute;s interesante de los estudios sobre la motivaci&oacute;n intr&iacute;nseca han sido las aportaciones que la psicolog&iacute;a cognitiva (Bandura) ha realizado respecto de la definici&oacute;n de procedimientos que pueden fomentar la motivaci&oacute;n intr&iacute;nseca para la realizaci&oacute;n de tareas que en principio suscitan poco inter&eacute;s o incluso rechazo por lo costoso o poco atractivo de su ejecuci&oacute;n. Resulta evidente la importancia de estos estudios para los campos propios de las especialidades laboral y educativa de la Psicolog&iacute;a.<br />
 	  </p>
 	<p align="justify">Actualmente se&nbsp; ha avanzado bastante sobre estos procedimientos, los cuales podemos clasificar en tres grupos:</p>
    <div align="justify">
      <ul>
        <li><em>Procedimientos centrados en la presentaci&oacute;n y planificaci&oacute;n de las tareas</em>.</li>
      </ul>
    </div>
    <p align="justify">Aqu&iacute; incluir&iacute;amos la participaci&oacute;n en la toma de decisiones, la variedad y novedad en el contenido de las tareas (para evitar la rutina y el aburrimiento), y las t&eacute;cnicas de establecimiento de objetivos. Al utilizar estas t&eacute;cnicas se ha de procurar que la dificultad de los objetivos se adec&uacute;e a las habilidades del sujeto y que &eacute;ste participe en la definici&oacute;n de metas, para potenciar su grado de compromiso y su sentido de autodeterminaci&oacute;n personal.</p>
    <div align="justify">
      <ul>
        <li><em>Procedimientos centrados en la ense&ntilde;anza de habilidades.</em></li>
      </ul>
    </div>
    <p align="justify">Los procedimientos que parece que facilitan al m&aacute;ximo la adquisici&oacute;n de habilidades nuevas y el fortalecimiento de la auto-eficacia son los de modelaje participante en los cuales el sujeto, en primer lugar, observa la habilidad en cuesti&oacute;n y, despu&eacute;s, la ejecuta y recibe retroalimentaci&oacute;n adecuada para corregir los errores.</p>
    <div align="justify">
      <ul>
        <li><em>Procedimientos de aplicaci&oacute;n de incentivos extr&iacute;nsecos.</em></li>
      </ul>
    </div>
    <p align="justify">En muchos casos, para motivar el aprendizaje de habilidades nuevas implicadas en la ejecuci&oacute;n de una tarea y fomentar el inter&eacute;s intr&iacute;nseco por &eacute;sta, no hay m&aacute;s remedio, en los comienzos, que hacer servir incentivos extr&iacute;nsecos (premios, reconocimientos verbales, etc.). A medida que el sujeto mejora sus habilidades, se pueden ir retirando de manera progresiva los incentivos extr&iacute;nsecos, ya que la actuaci&oacute;n h&aacute;bil producir&aacute; sus propios incentivos intr&iacute;nsecos.</p>
    <p align="justify">Te invitamos a  resolver la actividad de aprendizaje 4.3, la cual forma parte de tu  calificaci&oacute;n. Mucho &eacute;xito.</p>
  <a href="../../../../ActApart.jsp?unidad=4&amp;apartado=3">
 <h2>ACTIVIDAD DE APRENDIZAJE 4.3<br /></h2></a>
  </p><table width="100%" border="0" height="100%">
      <tr>
        <td width="20%"><div align="center"><a href= "ContLPSBC03PBC01_4_3_1.jsp" ><img src="Img/REGRESAR.png" width="99" height="32" /></a></div></td>
        <td class="label_Conceptual"><strong>4.3 MOTIVACI&Oacute;N</strong></td>
        <td width="20%"><div align="center"><a href= "ContLPSBC03PBC01_4_4_0.jsp" ><img src="Img/AVANZAR.png" width="99" height="32"/></a></div></td>
      </tr>
    </table>
 	<!-- InstanceEndEditable -->
