...
%>">
 	...
 	<h1 align="center"><strong>GLOSARIO</strong></h1>
 	<p align="justify"><strong>Aprendizaje: </strong>Es un proceso de adquisici&oacute;n de una disposici&oacute;n, relativamente duradera, para cambiar la percepci&oacute;n o la conducta como resultado de una experiencia. <br />
 	  <br />
 	  <strong>Atenci&oacute;n: </strong>Es una condici&oacute;n b&aacute;sica de nuestros procesos cognitivos que nos permite seleccionar m&aacute;s eficazmente la informaci&oacute;n que es relevante para el hombre con mayor claridad y orden, posee un car&aacute;cter focal que configura el objeto perceptivo en la estimulaci&oacute;n prioritaria y un car&aacute;cter activador-regulador en que la percepci&oacute;n funciona seg&uacute;n la atenci&oacute;n sostenida de forma continua. </p>
 	<p align="justify"><strong>Condicionamiento cl&aacute;sico:</strong> Proceso de aprendizaje mediante el cual un organismo establece una asociaci&oacute;n entre un est&iacute;mulo condicionado (EC) y un est&iacute;mulo incondicionado (EI), siendo el EC capaz de elicitar una respuesta condicionada (RC). Experimentalmente se obtiene esta forma de condicionamiento exponiendo el organismo a un EC y un EI en repetidas ocasiones. Tambi&eacute;n se denomina condicionamiento pavloviano.<strong></strong><br />
 	  </p>
 	<p align="justify"><strong>Condicionamiento operante: </strong>Es el tipo de aprendizaje en el que la conducta depende de las consecuencias que &eacute;sta tenga. La frecuencia o probabilidad de que una conducta se presente depender&aacute; de las consecuencias que tenga dicha conducta.<br />
 	  </p>
 	<p align="justify"><strong>Emoci&oacute;n: </strong>Son procesos psicol&oacute;gicos que frente a una amenaza a nuestro equilibrio, ya sea f&iacute;sico o psicol&oacute;gico; act&uacute;an para restablecerlo ejerciendo as&iacute; un papel adaptativo.<strong></strong><br />
 	  </p>
 	<p align="justify"><strong>Lenguaje: </strong>Es la funci&oacute;n de expresi&oacute;n del pensamiento en forma oral y escrita para la comunicaci&oacute;n y el entendimiento de los seres humanos. Nos plantea dos definiciones de pensamiento, una de las cuales se relaciona directamente con la resoluci&oacute;n de problemas.<strong> </strong><br />
 	  </p>
 	<p align="justify"><strong>Memoria: </strong>Es un registro de nuestras percepciones obtenida mediante nuestros sentidos, codifica la informaci&oacute;n y la guarda para luego ser recuperada.<br />
 	  </p>
 	<p align="justify"><strong>Motivaci&oacute;n:</strong> Es el impulso que lleva a la persona a actuar de determinada manera, es decir, que da origen a un comportamiento espec&iacute;fico. Este impulso a la acci&oacute;n puede ser provocado por un est&iacute;mulo externo, que proviene del ambiente, o generado internamente por procesos mentales del individuo. En este aspecto la motivaci&oacute;n se relaciona con el sistema de cognici&oacute;n del individuo. Cognici&oacute;n o conocimiento representa lo que las personas saben respecto de s&iacute; mismos y del ambiente que las rodea.<br />
 	  </p>
 	<p align="justify"><strong>Pensamiento</strong>: Es el proceso cognitivo por el que se elabora nueva informaci&oacute;n a partir de la disponible y que es capaz de resolver los problemas de los individuos, colocando al raciocinio como el desarrollo de pensamientos.<br />
 	  </p>
 	<p align="justify"><strong>Percepci&oacute;n: </strong>Es un proceso organizativo e interpretativo de los datos sensoriales que hacen tomar conciencia de las cosas que nos rodean y de uno mismo; consiste por tanto, en recibir est&iacute;mulos del medio a trav&eacute;s de los sentidos y dotarles de significado por medio de la mente, del conocimiento, de las experiencias y expectativas de la persona que posee.<br />
 	  </p>
 	<p align="justify"><strong>Razonamiento deductivo</strong>: Parte de categor&iacute;as generales para hacer afirmaciones sobre casos particulares. Va de lo general a lo particular. Es una forma de razonamiento donde se infiere una conclusi&oacute;n a partir de una o varias premisas.<br />
 	  </p>
 	<p align="justify"><strong>Razonamiento inductivo</strong>: Es aquel proceso en el que se razona partiendo de lo particular para llegar a lo general, justo lo contrario que con la deducci&oacute;n. La base de la inducci&oacute;n es la suposici&oacute;n de que si algo es cierto en algunas ocasiones, tambi&eacute;n lo ser&aacute; en situaciones similares aunque no se hayan observado.<br />
 	  <br />
