...
%>">
 	...
 	<h1 align="center"><strong>1.4 PROCESOS COGNOSCITIVOS BASICOS</strong>    </h1>
 	
    <div align="center">
        <object id="FlashID" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="670" height="335">
          <param name="movie" value="Swf/ContLPSBC03PBC01_1_4.swf" />
          ...
          <!--[if !IE]>-->
          <object type="application/x-shockwave-flash" data="Swf/ContLPSBC03PBC01_1_4.swf" width="670" height="335">
            <!--<![endif]-->
            <param name="quality" value="high" />
            <param name="wmode" value="opaque" />
            <param name="swfversion" value="15.0.0.0" />
 	...
 	<p align="justify">Lo que nos diferencia de los animales es la capacidad de pensar y utilizar el lenguaje para comunicarnos con los individuos de nuestra especie. Esta capacidad, por su complejidad, ha dado lugar a numerosos estudios. La explicaci&oacute;n de nuestro comportamiento o actuaci&oacute;n como un simple mecanismo de respuesta a partir de una estimulaci&oacute;n es insuficiente.<br />
 	  </p>
 	<p align="justify">Los seres humanos somos capaces de solucionar problemas (en mayor o menor grado), razonar, recordar experiencias, etc. Estas capacidades han sido estudiadas por lo psic&oacute;logos cognitivos en lo que denominan funciones o procesos cognitivos b&aacute;sicos al referirse a la atenci&oacute;n, la percepci&oacute;n y la memoria, y procesos cognitivos superiores o complejos al explicar el pensamiento. <br />
 	  </p>
 	<p align="justify">El estudio de los procesos cognitivos b&aacute;sicos a pesar de tener una historia tan larga como la de la psicolog&iacute;a misma, ha sido el territorio de un enfoque que durante los &uacute;ltimos a&ntilde;os ha tenido la &uacute;ltima palabra en cuanto a proceso se refiere. Estamos hablando de enfoque cognitivo y de sus modos de entender el proyecto experimental de la Psicolog&iacute;a en la actualidad.</p>
 	<table width="66%" height="178" border="0" align="center" cellpadding="15" cellspacing="0">
  <tr>
    <td width="30%" height="176" align="right"><img src="Img/UNIDAD 1/Intentodegif.gif" alt="" width="157" height="144" /></td>
    <td width="70%"><table width="95%" height="130" border="0" cellpadding="10" cellspacing="10">
      <tr>
        <td><p align="justify"><strong>I</strong><strong>dea Relevante</strong></p>
          <p align="justify"><strong>En enfoque cognitivo,</strong> o ciencia cognitiva, surgi&oacute; en el siglo XX como un marco te&oacute;rico y <strong>metodol&oacute;gico para el estudio de la mente.</strong></p></td>
      </tr>
    </table></td>
  </tr>
</table>
 	<p align="justify">La cognici&oacute;n constituye el campo avanzado de la psicolog&iacute;a dentro de las ciencias humanas y su estatus obedece tanto a la coherencia de sus modelos explicativos como a la rigurosidad de las estrategias metodol&oacute;gicas y experimentales en que se apoyan. <br />
</p>
 	<p align="justify">La Psicolog&iacute;a Cognitiva estudia lo que un sujeto conoce, comprende, piensa y su relaci&oacute;n con el mundo, todo lo que responde con base en procesos previos de selecci&oacute;n, an&aacute;lisis, organizaci&oacute;n, almacenamiento y recuperaci&oacute;n de informaci&oacute;n, con lo cual su conducta nunca es al azar, ni por ensayo y error, sino m&aacute;s bien una actividad basada en el establecimiento de relaciones. <br />
 	  </p>
 	<p align="justify">El an&aacute;lisis de los procesos cognitivos b&aacute;sicos incluye t&oacute;picos como la atenci&oacute;n, la percepci&oacute;n, el reconocimiento de patrones, la memoria, el lenguaje, la toma de decisiones el razonamiento la creatividad, el aprendizaje la inteligencia, las emociones, el control motor entre otros. <br />
</p>
<div> </div><table width="100%" border="0" height="100%">
      <tr>
        <td width="20%"><div align="center"><a href= "ContLPSBC03PBC01_1_3_1.jsp" ><img src="Img/REGRESAR.png" width="99" height="32" /></a></div></td>
        <td class="label_Conceptual"><strong>1.4 PROCESOS COGNOSCITIVOS BASICOS</strong></td>
        <td width="20%"><div align="center"><a href= "ContLPSBC03PBC01_1_4_1.jsp" ><img src="Img/AVANZAR.png" width="99" height="32"/></a></div></td>
      </tr>
    </table>
 	<!-- InstanceEndEditable -->
