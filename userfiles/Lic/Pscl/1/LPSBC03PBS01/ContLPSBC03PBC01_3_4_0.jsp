...
%>">
 	...
 	<h1 align="center"><strong>3.4 COMUNICACI&Oacute;N</strong><br />
 	  </h1>
 	<h2><strong>Actividad de Autodiagn&oacute;stico</strong><br />
 	  </h2>
 	<p>Te  invito a que resuelvas el siguiente test de comunicaci&oacute;n&nbsp; y compartas en alguna red social con tus  compa&ntilde;eros las respuestas y reflexiones, posteriormente revisa la informaci&oacute;n  que aqu&iacute; te proporcionamos: </p>
 	<p align="center">PsicoActiva.com.  (1998). &iquest;Te comunicas bien? Consultado el 12 de Diciembre de 2012, en: <a href="http://www.psicoactiva.com/tests/test2.htm" target="_blank"><strong>http://www.psicoactiva.com/tests/test2.htm</strong></a></p>
...
<p align="justify"><strong>Diagn&oacute;stico</strong></p>
<table width="688" border="0" align="center">
  <tr>
    <td width="132" align="right"><img src="Img/UNIDAD 3/Intentodegif.gif" alt="" width="157" height="144" /></td>
    <td width="546"><table width="100%" border="0" cellspacing="10" cellpadding="10">
      <tr>
        <td><p align="justify"><strong>I</strong><strong>dea Relevante</strong></p>
          <p align="justify">Palabra que deriva del lat&iacute;n &quot;comunicare&quot; que significa poner en com&uacute;n, compartir. La comunicaci&oacute;n es el intercambio verbal entre un hablante, que produce un enunciado destinado a otro hablante, y un interlocutor del que solicita la escucha y/o respuesta expl&iacute;cita o impl&iacute;cita (seg&uacute;n el tipo de enunciado).</p></td>
      </tr>
    </table></td>
  </tr>
</table>
...
<br />
<br />
<p align="justify">Es el hecho de que  una informaci&oacute;n se transmita de un punto a otro (lugar o persona). La  transmisi&oacute;n de esta informaci&oacute;n se hace mediante un mensaje que ha recibido una  cierta forma, que ha sido codificado.<br />
</p>
    <p align="justify">El esquema de la comunicaci&oacute;n&nbsp; supone la trasmisi&oacute;n de un mensaje entre un emisor y un receptor que poseen en com&uacute;n, al menos&nbsp; parcialmente,&nbsp; el c&oacute;digo necesario&nbsp; para la transmisi&oacute;n del mensaje.<br />
      </p>
    <p>Te  invito a que viajes a trav&eacute;s de la comunicaci&oacute;n:</p>
    <p align="center">      Emecad&oacute;s.  (2007). <em><a href="http://youtu.be/vZS9SuUyaWU" target="_blank"><strong>Viaje a trav&eacute;s de la comunicaci&oacute;n</strong></a></em><strong><a href="http://youtu.be/vZS9SuUyaWU">.</a></strong> Recuperado con fines did&aacute;cticos el 9 de Marzo de 2015, de: http://www.youtube.com/watch?v=nKofKgZD-60    </p>
    <p align="center"><strong>Para revisar el material indicado da clic en el siguiente enlace o bien, revisa la secci&oacute;n de Descargables en la plataforma.</strong></p>
    <h2><strong>Proceso de</strong> <strong>comunicaci&oacute;n</strong><br />
  </h2>
    <p align="justify">Para comenzar, te invito a que revises el siguiente video: &nbsp; </p>
    <p align="center">Alvarado,  G., De Jes&uacute;s, G. y Villalobos, J. (2012). <em><a href="http://youtu.be/dqaPY75qnfE" target="_blank">Proceso  de la comunicaci&oacute;n.</a></em> Recuperado con fines did&aacute;cticos el 9 de Marzo de 2015,  de: http://www.youtube.com/watch?v=vWv33ZGubts</p>
    <p align="center"><strong>Para revisar el material indicado da clic en el siguiente enlace o bien, revisa la secci&oacute;n de Descargables en la plataforma.</strong></p>
    <p align="justify">El acto de comunicar es un proceso complejo en el que dos o m&aacute;s personas se relacionan y, &nbsp;a trav&eacute;s de un intercambio de mensajes con c&oacute;digos similares, tratan de comprenderse e influirse de forma que sus objetivos sean aceptados en la forma prevista, utilizando un canal que act&uacute;a de soporte en la transmisi&oacute;n de la informaci&oacute;n.<br />
    </p>
    <p align="justify">La comunicaci&oacute;n constituye una caracter&iacute;stica y una necesidad de las personas y de las sociedades con el objetivo de poder intercambiarse informaciones y relacionarse entre s&iacute;.<br />
      </p>
    <h2><strong>Elementos que intervienen en la comunicaci&oacute;n</strong> <br />
    </h2>
    <p align="justify">Aunque la comunicaci&oacute;n es un proceso complejo, para efectos did&aacute;cticos podemos descomponerlo en los diferentes elementos que lo integran.</p>

<p align="center"><img src="Img/UNIDAD 3/pcb_un3img18.jpg" width="450" height="230" /></p>
<p align="center">&nbsp;</p>
<p align="center"><strong>FIGURA 2. ELEMENTOS QUE INTERVIENEN EN LA COMUNICACI&Oacute;N</strong></p>

<div align="center">
        <object id="FlashID" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="670" height="644">
          <param name="movie" value="Swf/ContLPSBC03PBC01_3_3.swf" />
          ...
          <!--[if !IE]>-->
          <object type="application/x-shockwave-flash" data="Swf/ContLPSBC03PBC01_3_3.swf" width="670" height="644">
            <!--<![endif]-->
            <param name="quality" value="high" />
            <param name="wmode" value="opaque" />
            <param name="swfversion" value="15.0.0.0" />
...
<p align="center">(www.profesorenlinea.cl., s/f)<br />
  <strong><br />
</strong></p><table width="100%" border="0" height="100%">
      <tr>
        <td width="20%"><div align="center"><a href= "ContLPSBC03PBC01_3_3_0.jsp" ><img src="Img/REGRESAR.png" width="99" height="32" /></a></div></td>
        <td class="label_Conceptual"><p><strong>3.4 COMUNICACI&Oacute;N</strong></p></td>
        <td width="20%"><div align="center"><a href= "ContLPSBC03PBC01_3_4_1.jsp" ><img src="Img/AVANZAR.png" width="99" height="32"/></a></div></td>
      </tr>
    </table>
 	<!-- InstanceEndEditable -->
