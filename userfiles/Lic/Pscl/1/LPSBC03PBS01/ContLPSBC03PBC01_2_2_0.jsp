...
%>">
 	...
 	<h1 align="center"><strong>2.2 LA ATENCI&Oacute;N</strong> 	</h1>
 	<p align="center"><img src="Img/UNIDAD 2/pcb_un2img20.jpg" width="237" height="213" /></p>
 	<p align="justify">&nbsp;</p>
 	<p align="justify">Dicho de otro modo, la atenci&oacute;n es un proceso cognitivo en el que el sujeto selecciona la informaci&oacute;n y procesa s&oacute;lo algunos datos de entre la m&uacute;ltiple estimulaci&oacute;n sensorial. Se puede constatar esto, cuando realizamos cualquier actividad (ya sea m&uacute;ltiple, visual, manipulativa, etc.) en el hecho de centrar la atenci&oacute;n sobre un aspecto determinado y dejar de atender a otras cosas que suceden a nuestro alrededor; por ejemplo, al leer este texto nuestra atenci&oacute;n est&aacute; dirigida a la compresi&oacute;n de dicho texto, aunque tambi&eacute;n hay otro est&iacute;mulos a nuestro alrededor susceptibles de ser atendidos, como papeles sobre la mesa, otros ruidos de fondo, los muebles de la habitaci&oacute;n, los ni&ntilde;os jugando, etc&eacute;tera, estamos llevando a cabo una selecci&oacute;n de toda la informaci&oacute;n que nos rodea en este momento.Si no se llevara a cabo esta selecci&oacute;n, ser&iacute;a imposible manejar todos los datos que captan los receptores sensoriales.<br />
 	  <br />
    </p><table width="100%" border="0" height="100%">
      <tr>
        <td width="20%"><div align="center"><a href= "ContLPSBC03PBC01_2_1_2.jsp" ><img src="Img/REGRESAR.png" width="99" height="32" /></a></div></td>
        <td class="label_Conceptual"><p><strong>2.2 LA ATENCI&Oacute;N</strong></p></td>
        <td width="20%"><div align="center"><a href= "ContLPSBC03PBC01_2_2_1.jsp" ><img src="Img/AVANZAR.png" width="99" height="32"/></a></div></td>
      </tr>
    </table>
 	<!-- InstanceEndEditable -->
