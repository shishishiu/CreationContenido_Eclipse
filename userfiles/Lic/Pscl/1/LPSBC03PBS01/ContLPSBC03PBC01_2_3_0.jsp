...
%>">
 	...
 	<h1 align="center"><strong>2.3 APRENDIZAJE</strong> 	</h1>
 	<p align="justify">Se entiende por aprendizaje, un cambio relativamente permanente en el comportamiento, que refleja una adquisici&oacute;n de conocimientos o habilidades a trav&eacute;s de la experiencia y que puede incluir el estudio, la observaci&oacute;n y la pr&aacute;ctica. Los cambios en el comportamiento son relativamente objetivos y por lo tanto pueden ser medidos.</p>
<p align="center"><img src="Img/UNIDAD 2/pcb_un2img29.gif" width="137" height="130" /></p>
<p align="center">&nbsp;</p>
<table width="65%" border="0" align="center">
  <tr>
    <td width="30%" align="right"><img src="Img/UNIDAD 2/Intentodegif.gif" alt="" width="157" height="144" /></td>
    <td width="70%"><table width="100%" border="0" cellspacing="10" cellpadding="10">
      <tr>
        <td><p align="justify"><strong>I</strong><strong>dea Relevante</strong></p>
          <p align="justify">El aprendizaje implica un proceso constructivo interno, autoestructurante y en este sentido, es subjetivo y personal.</p></td>
      </tr>
    </table></td>
  </tr>
</table>
<div align="center">
  <p align="justify">Es el proceso por el cual se despliegan patrones de conducta predeterminados siguiendo m&aacute;s o menos un programa.&nbsp; Este concepto de aprendizaje tambi&eacute;n excluye los reflejos, que son innatos, respuestas involuntarias a una estimulaci&oacute;n, m&aacute;s que cambios relativamente permanentes realizados por experiencia.<br />
  </p>
  <p align="justify">A menudo el aprendizaje puede ser deducido por un cambio en el comportamiento, sin embargo no siempre es as&iacute;.&nbsp; Es importante no confundir aprendizaje con ejecuci&oacute;n.&nbsp; Hay veces en que hay aprendizaje y por fatiga la ejecuci&oacute;n no se demuestra a esto se le denomina aprendizaje latente.<br />
    <br />
  </p>
</div><table width="100%" border="0" height="100%">
      <tr>
        <td width="20%"><div align="center"><a href= "ContLPSBC03PBC01_2_2_2.jsp" ><img src="Img/REGRESAR.png" width="99" height="32" /></a></div></td>
        <td class="label_Conceptual"><p><strong>2.3 APRENDIZAJE</strong></p></td>
        <td width="20%"><div align="center"><a href= "ContLPSBC03PBC01_2_3_1.jsp" ><img src="Img/AVANZAR.png" width="99" height="32"/></a></div></td>
      </tr>
    </table>
 	<!-- InstanceEndEditable -->
