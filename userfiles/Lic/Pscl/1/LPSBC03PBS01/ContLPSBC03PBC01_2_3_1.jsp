...
%>">
 	...
 	<h2><strong>2.3.1 TIPOS DE APRENDIZAJE</strong> 	</h2>
 	<p align="center"><img src="Img/UNIDAD 2/pcb_un2img30.jpg" width="655" height="482" /><br />
    <br />
  </p>
 	<div align="center"> </div><table width="100%" border="0" height="100%">
      <tr>
        <td width="20%"><div align="center"><a href= "ContLPSBC03PBC01_2_3_0.jsp" ><img src="Img/REGRESAR.png" width="99" height="32" /></a></div></td>
        <td class="label_Conceptual"><p><strong>2.3 APRENDIZAJE</strong></p></td>
        <td width="20%"><div align="center"><a href= "ContLPSBC03PBC01_2_3_2.jsp" ><img src="Img/AVANZAR.png" width="99" height="32"/></a></div></td>
      </tr>
    </table>
 	<!-- InstanceEndEditable -->
